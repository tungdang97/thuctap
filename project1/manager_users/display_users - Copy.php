			...
			<tbody>
				<?php while ($row = mysqli_fetch_assoc($result)) { ?>
					<tr>
						...
						<td>
							<div class="btn-group">
							<button type="button" class="btn btn-info edit_data" onclick="thongtin()">
						...
						<div class="modal-dialog">
							...
							<div class="modal-body">
								...
								<div class="box-body">
									...
									<input type="text" value="" class="form-control" name="phone" id="phone" placeholder="Enter contact number">
									</div>
									<div class="form-group">			
									<label>
									Sex
